...
\begin{tabular}{c c}
\hline Digitaler Kanal $K$ & Energie $E$ / \unit{\kilo\electronvolt} \\ 
\hline
$\num{83.57\pm 0.09}$ & $\num{6.40384}$ \\
$\num{88.1\pm 0.2}$ & $\num{7.05798}$ \\
$\num{112.62\pm 0.13}$ & $\num{8.63886}$ \\
...
von Kupfer und Zink sind seltener Vorzufinden. Am üblichsten sind Legierung mit etwa $40\%$ Zink, die 
